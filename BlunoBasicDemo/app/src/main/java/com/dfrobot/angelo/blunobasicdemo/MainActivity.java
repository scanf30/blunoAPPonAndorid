...
public class MainActivity  extends BlunoLibrary {
	...
	private String Sup     = "a";
	private String Sdown   = "b";
	private String Sright  = "c";
	private String Sleft   = "d";
	private String Scentre = "e";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		highButton  = (Button) findViewById(R.id.upButton);
